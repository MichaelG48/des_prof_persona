    ...
    <div class="flex-container">
        <form id="formularioPersona" name ="formularioPersona" runat="server">
            ...
            <%--<div class="flex-box">
                ...
                <asp:TextBox ID="txtFechaNacimiento" onchange="mostrarLabel(this)" placeholder="Fecha de nacimiento" runat="server" ></asp:TextBox>
                <asp:ImageButton ID="imgPopup" ImageUrl="imageurl" runat="server" />
                ...
                <asp:RequiredFieldValidator ID="rfvFechaNac" runat="server" ControlToValidate="txtCurp" ErrorMessage="Campo obligatorio"></asp:RequiredFieldValidator>
            </div>--%>
